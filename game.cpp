...
int main()
  ...
  cout << "Welcome to the game FIND A WHITE BIRD. Here are the rules of the game. You are a hunter BLUE BIRD.
  You need to find the hidden WHITE BIRDS inputing x(in range from 0 to 10) and y(from 0 to 4) coordinates. If
  you are lucky you earn 50 points, if not we have a bonus for you! 10 points! But disaster! If you meet RED BIRD,
  you will loose 100 poins and the game. Now... Good luck!!!   "
  do {
    cout << "Pls input BLUE BIRD'S x and y coordinates:   x:  ";  cin >> blue_bird_x;
    cout << "y:  "; cin >> blue_bird_y;
    cout << endl;
